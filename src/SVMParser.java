	...
	public final AssemblyContext assembly() throws RecognitionException {
		...
		try {
			...
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << PUSH) | (1L << POP) | (1L << ADD) | (1L << SUB) | (1L << MULT) | (1L << DIV) | (1L << STOREW) | (1L << LOADW) | (1L << BRANCH) | (1L << BRANCHEQ) | (1L << BRANCHLESSEQ) | (1L << JS) | (1L << LOADRA) | (1L << STORERA) | (1L << LOADRV) | (1L << STORERV) | (1L << LOADFP) | (1L << STOREFP) | (1L << COPYFP) | (1L << LOADHP) | (1L << STOREHP) | (1L << PRINT) | (1L << HALT) | (1L << LABEL))) != 0)) {
				...
				case 6:
					{
					setState(14); match(MULT);
					code[i++] = MULT;
					}
					break;
				case 7:
					{
					setState(16); match(DIV);
					code[i++] = DIV;
					}
					break;
				case 8:
					{
					setState(18); match(STOREW);
					code[i++] = STOREW;
					}
					break;
				case 9:
				...
				case 13:
					{
					setState(31); match(BRANCHLESSEQ);
				...
				case 14:
					{
					setState(34); match(JS);
					code[i++] = JS;
					}
					break;
				case 15:
					{
					setState(36); match(LOADRA);
					code[i++] = LOADRA;
					}
					break;
				case 16:
					{
					setState(38); match(STORERA);
					code[i++] = STORERA;
					}
					break;
				case 17:
				...
				case 19:
					{
					setState(44); match(LOADFP);
					code[i++] = LOADFP;
					}
					break;
				case 20:
					{
					setState(46); match(STOREFP);
					code[i++] = STOREFP;
					}
					break;
				case 21:
					{
					setState(48); match(COPYFP);
					code[i++] = COPYFP;
					}
					break;
				case 22:
					{
					setState(50); match(LOADHP);
					code[i++] = LOADHP;
					}
					break;
				case 23:
					{
					setState(52); match(STOREHP);
					code[i++] = STOREHP;
					}
					break;
				case 24:
